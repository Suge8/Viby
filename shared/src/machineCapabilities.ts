export const MACHINE_CAPABILITIES = ['browse-directory'] as const
...
export function machineSupportsBrowseDirectory(capabilities: readonly string[] | null | undefined): boolean {
