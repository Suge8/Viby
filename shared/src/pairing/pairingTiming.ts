...
export const PAIRING_HANDOFF_TICKET_TTL_SECONDS = 10 * 60
...
export const PAIRING_ICE_DISCONNECTED_RESTART_DELAY_MS = 750
export const PAIRING_STATS_POLL_INTERVAL_MS = 5_000
export const PAIRING_LINK_SAMPLE_STALE_MS = PAIRING_STATS_POLL_INTERVAL_MS * 3
...
export const PAIRING_TUNNEL_READY_TIMEOUT_MS = 8_000
