...
import { I18nProvider, type Locale, resolveInitialLocale } from '@/lib/i18n-context'
...
export async function renderWithI18n(ui: ReactElement, options?: RenderWithI18nOptions): Promise<RenderResult> {
