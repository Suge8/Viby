const MESSAGE_WINDOW_WARNING_KEYS = [
    ...
    'chat.messagesWarning.postSwitchNoReply'
] as const

const POST_SWITCH_MESSAGE_WINDOW_WARNING_KEYS = [
    'chat.messagesWarning.postSwitchSendFailed',
    'chat.messagesWarning.postSwitchNoReply'
] as const
...
export const MESSAGE_WINDOW_POST_SWITCH_NO_REPLY_WARNING_KEY = 'chat.messagesWarning.postSwitchNoReply'
...
export function isPostSwitchMessageWindowWarningKey(
    ...
    return typeof value === 'string'
        && (POST_SWITCH_MESSAGE_WINDOW_WARNING_KEYS as readonly string[]).includes(value)
}
