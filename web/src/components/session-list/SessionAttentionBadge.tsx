...
const ATTENTION_BADGE_CLASS_NAME =
    'ds-session-attention-badge inline-flex min-h-6 items-center gap-1 rounded-full bg-[var(--app-attention-bg)] px-2 py-0.5 font-semibold text-[var(--app-attention-text)]'
const ATTENTION_ICON_CLASS_NAME = 'h-3.5 w-3.5 shrink-0 fill-current text-[var(--app-attention-text)]'
const COMPACT_ATTENTION_BADGE_CLASS_NAME =
    'ds-session-attention-badge-compact inline-flex min-h-5 items-center gap-0.5 rounded-full bg-[var(--app-attention-bg)] px-1.5 py-0.5 font-semibold text-[var(--app-attention-text)]'
