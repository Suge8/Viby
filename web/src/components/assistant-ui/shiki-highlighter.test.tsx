...
describe('SyntaxHighlighter', () => {
    it('reuses the shared code surface owner for assistant markdown code blocks', () => {
        ...
        expect(screen.getByTestId('code-surface')).toHaveAttribute('data-class-name', 'aui-md-codeblock rounded-b-md rounded-t-none')
        ...
        expect(screen.getByTestId('code-content')).toHaveAttribute('data-highlight', 'always')
