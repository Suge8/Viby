export type InteractiveCardStyleMode =
    | 'disclosure-trigger'
    | 'full-card'
    | 'stacked-full-card'
    | 'section-trigger'
...
const INTERACTIVE_CARD_CLASS_NAME_BY_MODE: Record<InteractiveCardStyleMode, string> = {
    ...
    'centered-tile':
        'w-full text-center [&>[data-button-content]]:w-full [&>[data-button-content]]:flex-col [&>[data-button-content]]:items-center [&>[data-button-content]]:justify-center',
}
