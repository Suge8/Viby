...
const buttonVariants = cva(
    'ds-button inline-flex min-h-[var(--ds-touch-target)] items-center justify-center whitespace-nowrap rounded-full text-sm font-semibold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ds-brand)] focus-visible:ring-offset-2 focus-visible:ring-offset-transparent disabled:pointer-events-none disabled:opacity-50',
    {
        variants: {
            variant: {
                default:
                    'border border-[var(--ds-brand)] bg-[var(--ds-brand)] text-[var(--app-button-text)] shadow-[var(--ds-shadow-soft)] [--ds-button-pointer-color:var(--ds-text-inverse)] [--ds-button-sheen-color:255_255_255]',
                secondary:
                    'border border-[var(--ds-border-default)] bg-[var(--ds-panel-strong)] text-[var(--app-fg)] shadow-[var(--ds-shadow-soft)] hover:border-[var(--ds-border-strong)] hover:bg-[var(--app-subtle-bg)] [--ds-button-pointer-color:var(--ds-brand)] [--ds-button-sheen-color:255_255_255]',
                outline:
                    'border border-[var(--ds-border-default)] bg-transparent text-[var(--app-fg)] hover:border-[var(--ds-border-strong)] hover:bg-[var(--app-subtle-bg)] [--ds-button-pointer-color:var(--ds-brand)] [--ds-button-sheen-color:255_255_255]',
                destructive:
                    'border border-[var(--ds-danger)] bg-[var(--ds-danger)] text-[var(--ds-text-inverse)] shadow-[var(--ds-shadow-soft)] [--ds-button-pointer-color:var(--ds-text-inverse)] [--ds-button-sheen-color:255_255_255]',
            ...
            size: {
                ...
                icon: 'min-h-0 h-[var(--ds-touch-target)] w-[var(--ds-touch-target)] px-0',
...
function setButtonPointerHotspot(element: HTMLButtonElement, clientX: number, clientY: number): void {
