...
const PLUGIN_FILENAME = 'viby-hook.ts';
...
function buildPluginSource(hookUrl: string, token: string): string {
    ...
    return [
        '// Generated by Viby. Do not edit manually.',
        '',
        `const DEFAULT_HOOK_URL = ${escapedUrl};`,
        `const DEFAULT_HOOK_TOKEN = ${escapedToken};`,
        'const HOOK_URL = process.env.VIBY_OPENCODE_HOOK_URL || DEFAULT_HOOK_URL;',
        'const HOOK_TOKEN = process.env.VIBY_OPENCODE_HOOK_TOKEN || DEFAULT_HOOK_TOKEN;',
        '',
        ...
        '}',
        '',
        'export const VibyHookPlugin = async () => {',
        '    return {',
        '        event: async ({ event }) => {',
