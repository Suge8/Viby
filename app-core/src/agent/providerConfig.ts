...
export function resolvePermissionModeForDriver(value: unknown, driver: SessionDriver): SessionPermissionMode {
...
export function assertSessionConfigPayload(payload: unknown): Record<string, unknown> {
