...
import { type CursorStreamEvent, convertCursorEventToAgentMessage, parseCursorEvent } from './cursorEventConverter'

describe('cursorEventConverter', () => {
    describe('parseCursorEvent', () => {
        it('parses system init event', () => {
            const line =
                '{"type":"system","subtype":"init","apiKeySource":"login","cwd":"D:\\\\projects\\\\viby","session_id":"cec26d70-d2d5-48ac-a88b-9e820eb201cf","timestamp_ms":1772422778942}'
