...
export class PiSession extends AgentSessionBase<PiMode> {
    ...
    sendStreamUpdate(update: Parameters<RuntimeSessionClient['sendStreamUpdate']>[0]): void {
        this.client.sendStreamUpdate(update)
    }

    sendOutputMessage(...args: Parameters<RuntimeSessionClient['sendOutputMessage']>): void {
