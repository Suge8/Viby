...
import type { RuntimeSessionRecoveryResponse, SessionModelReasoningEffort } from '@/api/types'
...
export function rehydratePiMessages(messages: RuntimeSessionRecoveryResponse['messages']): PiMessage[] {
