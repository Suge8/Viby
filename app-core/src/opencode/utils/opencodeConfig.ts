 ...
 *
 * Generates opencode.json with VIBY MCP bridge configuration and optional
...
const INSTRUCTIONS_FILENAME = 'viby-instructions.md'
 ...
 * @param mcpServer - The Viby MCP server command configuration
