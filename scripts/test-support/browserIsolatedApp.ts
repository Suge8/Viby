...
import { resolveChromeExecutablePath } from '../test-support/browserSmokeRuntime'
import type {
    BrowserConsoleEvent,
    BrowserLogEntry,
...
import { wireBrowserObservability } from './appLikeRouteBrowserProbe'
