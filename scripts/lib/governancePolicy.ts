export const verifyBunVersion = '1.3.11'
export const rootPackageManager = `bun@${verifyBunVersion}`
export const rootBunEngineRange = `>=${verifyBunVersion} <2`
...
export const requiredRootTestScripts = [
    'test:runtime',
    'test:hub',
    'test:web',
    'test:pairing',
...
export const fireAndForgetOwnerFiles = new Set([
    'app-core/src/agent/runtimeLifecycle.ts',
    'app-core/src/runtime/session/trackedSessionControl.ts',
    'app-core/src/modules/watcher/startFileWatcher.ts',
    'app-core/src/utils/spawnWithAbort.ts',
    'hub/src/devHot.ts',
...
export const zodOwnerFiles = new Set([
    ...
    'app-core/src/agent/vibyToolSchemas.ts',
    'app-core/src/claude/types.ts',
    'app-core/src/pi/vibyTeamIntegration.ts',
])

export const sqlOwnerPrefixes = [
    'hub/src/store/',
    'hub/scripts/',
    'app-core/src/opencode/utils/opencodeStorageDatabase',
] as const

export const explicitControlSurfaceOwnerFiles = new Set([
    'app-core/scripts/sessionCapabilityBridgeSmoke.ts',
    'app-core/src/agent/backends/acp/acpSessionUpdateTracker.ts',
    'app-core/src/agent/idleRuntimeStopController.ts',
    'app-core/src/agent/keepAliveController.ts',
    'app-core/src/agent/readyEventScheduler.ts',
    'app-core/src/api/runtimeEventTransport.ts',
    'app-core/src/api/providerAdapterSessionClient.ts',
    'app-core/src/api/providerAdapterEventChannel.ts',
    'app-core/src/api/rpc/RpcHandlerManager.ts',
    'app-core/src/runtime/session/providerAdapterBridge.ts',
    'app-core/src/runtime/session/spawnProcess.ts',
    'app-core/src/runtime/RuntimeSupervisor.ts',
    'app-core/src/claude/claudeRemoteLauncher.ts',
    'app-core/src/claude/sdk/QueryRuntime.ts',
    'app-core/src/cursor/cursorRemoteLauncher.ts',
    'app-core/src/modules/common/session/BaseSessionScanner.ts',
    'app-core/src/modules/watcher/awaitFileExist.ts',
    'app-core/src/opencode/utils/opencodeStorageScanner.ts',
    'app-core/src/pi/runPi.ts',
    'app-core/src/terminal/TerminalManager.ts',
    'app-core/src/utils/time.ts',
    'app-core/src/copilot/copilotRemoteLauncher.ts',
    'app-core/src/codex/codexAppServerBridge.ts',
    'app-core/src/codex/codexRemoteCoordinator.ts',
    'app-core/src/codex/codexRemoteTurnLifecycle.ts',
    'app-core/src/modules/common/commandCapabilityCache.ts',
    'hub/src/notifications/notificationHub.ts',
    'hub/src/runtime/RuntimeEventIngestor.ts',
    'hub/src/runtime/runtimeCapabilityCache.ts',
    'hub/src/socket/handlers/terminal.ts',
    'hub/src/socket/server.ts',
    'hub/src/sync/eventPublisher.ts',
    'hub/src/sync/messageService.ts',
    'hub/src/sync/sessionRuntimeStateService.ts',
    'hub/src/sync/syncEngine.ts',
    'hub/src/sync/syncEngineServiceFactory.ts',
    'desktop/src/App.tsx',
    'desktop/src/components/AgentConfigFieldControl.tsx',
    'desktop/src/components/AgentConfigPanel.tsx',
    'desktop/src/hooks/useDesktopPairings.ts',
    'desktop/src/hooks/useDeviceAuthSummary.ts',
    'desktop/src/hooks/usePairingBridges.ts',
    'desktop/src/lib/pairingBridgeController.ts',
    'desktop/src/lib/pairingBridgeControllerSupport.ts',
    'desktop/src/lib/pairingBridgeDataChannel.ts',
    'desktop/src/lib/pairingBridgeRouteCommit.ts',
    'desktop/src/lib/pairingBridgeStateEmitter.ts',
    'desktop/src/lib/pairingBridgeChannelHealth.ts',
    ...
    'desktop/src/lib/pairingRelayBridgeRuntime.ts',
    ...
    'web/src/components/AppController.tsx',
    'web/src/components/AppRealtimeRuntime.tsx',
    'pairing/src/httpSessionRoutes.ts',
    ...
    'web/src/remote/remotePairingReactHooks.ts',
    'web/src/remote/remotePairingRelaySocket.ts',
    'web/src/remote/RemotePairingRuntime.tsx',
    'web/src/remote/remotePairingReconnectLoop.ts',
    'web/src/remote/remotePairingTransportBridge.ts',
    'web/src/remote/remotePeerSessionTrace.ts',
    'web/src/remote/useRemotePairingLinkStats.ts',
    ...
    'web/src/components/AssistantChat/ConversationOutline.tsx',
    ...
    'web/src/components/AssistantChat/useTranscriptActiveTurnAnchor.ts',
    'web/src/components/AssistantChat/useTranscriptBottomEffects.ts',
    ...
    'web/src/components/MemberControlBanner.tsx',
    'web/src/components/NewSession/useRecoverLocalState.ts',
    ...
    'web/src/components/useSessionChatWorkspaceModel.ts',
    'web/src/components/useSessionTranscriptModel.ts',
    'web/src/components/TeamHistoryDrawer.tsx',
...
function countFireAndForgetRefs(repoPath: string, source: string): number {
    ...
    const isBackendSource =
        repoPath.startsWith('app-core/src/') ||
