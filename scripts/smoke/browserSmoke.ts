...
import { sanitizeArtifactSegment } from '../lib/support'
import {
...
} from '../test-support/browserSmokeRuntime'
import {
    attachToPageTarget,
...
} from '../test-support/browserSmokeSupport'
...
const outputDir = resolve(
    repoRoot,
    process.env.VIBY_BROWSER_SMOKE_OUT_DIR || `web/.artifacts/smoke/${timestamp}-${smokeLabel}`
)
...
async function main(): Promise<void> {
    ...
    console.log(`[smoke] browser smoke passed. Artifacts: ${outputDir}`)
}
