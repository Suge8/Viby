...
- `docs/development/app-core-runtime-boundaries.md`：迁移期 AppCore runtime、runner、resume token 边界
...
- `docs/internal/harness-constitution.md`：本地内部验证宪法
...
- `docs/internal/harness-standards.md`：可机械执行的验证标准
